...
**项目规划**：
- [问题定义](docs/问题定义.md) — 核心技术冲突与目标用户痛点
- [需求分析](docs/需求分析.md) — 功能/非功能需求、MVP 边界、验收标准
- [产品设计文档](docs/产品设计文档.md) — 用户画像、功能设计、交互设计、竞品分析

**技术设计**：
- [技术可行性调研](docs/技术可行性调研.md) — 工具选型对比与关键技术算法
- [技术架构文档](docs/技术架构文档.md) — 分层架构、数据架构、接口设计、安全架构
- [数据库设计文档](docs/数据库设计文档.md) — SQLite 表结构、LanceDB Schema、NetworkX 图设计
- [API 接口文档](docs/API接口文档.md) — 核心服务接口定义、数据模型、使用示例
- [安全设计文档](docs/安全设计文档.md) — 沙箱隔离、命令过滤、Prompt 注入防御
- [架构决策记录](docs/架构决策记录.md) — 10 项关键技术选型的决策过程与理由

**开发与使用**：
- [开发环境搭建指南](docs/开发环境搭建指南.md) — 环境配置、依赖安装、开发工具
- [用户使用手册](docs/用户使用手册.md) — 面向最终用户的详细操作手册
- [测试计划文档](docs/测试计划文档.md) — 测试策略、用例设计、覆盖率目标
