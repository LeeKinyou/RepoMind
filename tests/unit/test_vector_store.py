...
class TestVectorStoreCRUD:
    def test_add_search_delete_flow(self, tmp_dir):
        ...
        entry1 = VectorEntry(id="file1.py:func1", text="def func1(): pass", vector=[0.1, 0.2, 0.3, 0.4])
        entry2 = VectorEntry(id="file2.py:func2", text="def func2(): pass", vector=[0.5, 0.6, 0.7, 0.8])
